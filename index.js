...
const { getDashboardData, googleSheetTest, updateStudentIds, googleSheetDataTutor, getMapleStudent, mapleSheetUpdate, getDashboardDataTest } = require('./Controllers/DashboardData');
...
io.on("connection", (socket) => {
  ...
  socket.on("clientLeft", (roomName) => {
    console.log("number " + getNumberOfClients(roomName));
  })
})
