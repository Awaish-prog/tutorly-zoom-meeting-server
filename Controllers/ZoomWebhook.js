...
function downloadRecording(req, res){
  ...
  if (req.headers['x-zm-signature'] === signature) {
    ...
    let f = (String(req.body.payload.object.topic) + " TEST " + (new Date(req.body.payload.object.start_time)).toLocaleString('en-US', { timeZone: 'America/Los_Angeles' })).replaceAll("/", "-")
